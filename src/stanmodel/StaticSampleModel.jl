...
mutable struct StaticSampleModel
...
Create a StaticSampleModel and compile Stan Language Model.
...
"""
function StaticSampleModel(name::AbstractString, model::AbstractString,
    tmpdir=mktempdir())
...
function Base.show(io::IO, ::MIME"text/plain", m::StaticSampleModel)
    println("\nModel name:")
